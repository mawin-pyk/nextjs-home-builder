...
function ServiceHomeBuildingSetting() {
    ...
    const getServices = async () => {
        setLoading(true);
        try {
            const res = await fetch(`/api/admin/service-home-building-setting`);
    ...
    const deleteService = async (id) => {
        setLoading(true);
        try {
            const res = await fetch(`/api/admin/service-home-building-setting/${id}`, {
                method: "DELETE",
            });
    ...
    const getService = async (id) => {
        ...
        try {
            ...
            const filesWithPreview = (service.images || []).map((url) => {
    ...
    return (
        ...
        >
            ...
            <Dialog
                ...
                scroll="body"
            >
                <DialogTitle>{editId ? "แก้ไขจังหวัด" : "เพิ่มจังหวัด"}</DialogTitle>
                <DialogContent>
                    <Box
                        component="form"
                        onSubmit={handleSubmit((data) => {
                            if (editId) {
                                updateService(data, editId);
...
export default ServiceHomeBuildingSetting;
